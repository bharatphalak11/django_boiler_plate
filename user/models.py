...
class User(AbstractBaseUser):
    ...
    email_code_created_date = models.DateTimeField(null=True)
    forgot_password_code = models.CharField(max_length=100, null=True)
    forgot_password_code_created_date = models.DateTimeField(null=True)
